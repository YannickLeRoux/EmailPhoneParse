...
email address(es) and US phone number(s)

Author: armisha padariya

http://github.com/armishapdariya
'''
...
if len(phone) == 0:
    print ("Sorry for inconvenience, no number foud!!")
...
if len(emails) == 0:
    print("Sorry for inconvenience, no email address found!!")
    print('----****----')
    print()
else:
    count = 1
